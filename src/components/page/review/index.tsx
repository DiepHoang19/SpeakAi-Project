  ...
  return (
    <div className="mt-[4rem]">
      <div className="text-center p-8">
        <p className="text-[40px] font-[600] text-white">What Our Users Say</p>
        <p className="text-[15px] text-white">
          Thousands of language learners have transformed their speaking
          abilities with SpeakAl.
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="max-w-sm p-6 bg-[#190b37] border border-[#291650] rounded-[16px] shadow-sm">
            <figure className="max-w-screen-md">
              <div className="flex items-center mb-4 text-[#5521B5]">
                <svg
          ...
          <div className="max-w-sm p-6 bg-[#190b37] border border-[#190b37] rounded-[16px] shadow-sm">
            <figure className="max-w-screen-md">
              <div className="flex items-center mb-4 text-[#5521B5]">
                <svg
                  className="w-4 h-4 me-1"

  ...
  return (
    <>
      <div className="bg-[#231246] border border-[#39246c] rounded-[16px] relative shadow-sm p-6">
        ...
        <h5 className="text-xl font-bold text-white">Conversation Starters</h5>
        <h5 className="text-sm font-bold text-[#bebace] mt-2">
          Practice starting conversations in various social situations.
        </h5>
...
export default ConvertstationStaterts;
